...
mod tests {
    ...
    fn parse_packet_literal() {
        let raw = "110100101111111000101000";    
        let (_, lit) = PacketLiteral::parse(raw).unwrap();
        assert_eq!(lit.value, 0b11111100101);
        // assert_eq!(lit.extra_end_bits, Some("000".to_string()));
        assert_eq!(lit.header.version, 6);
        assert_eq!(lit.header.type_id, 4);
    }

    #[test]
    fn parse_packet_literal_long() {
        let raw = "110100010100101001000100100";
        let (rest, lit) = Packet::parse(raw).unwrap();
        // assert_eq!(lit.value, 0b1010);
        assert!(matches!(lit, Packet::Literal(_)));
        assert_eq!(rest, "0101001000100100");
    }
    ...
    #[test]
    fn parse_packet_from_hex() {
        let raw = "";
    ...
    #[test]
    fn parse_packet_from_hex5() {
        let raw = "38006F45291200";
        let bin = raw.chars().map(|c| format!("{:04b}", c.to_digit(16).unwrap())).collect::<String>();
        let (_, packet) = Packet::parse(&bin).unwrap();
        assert_eq!(packet.sum_version_numbers(), 9);
    }
}
